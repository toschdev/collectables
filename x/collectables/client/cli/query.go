...
Example:
$ %s query %s collection collectables
`, version.ClientName, types.ModuleName,
			),
		),
		Args: cobra.ExactArgs(1),
...
Example:
$ %s query %s token collectables d04b98f48e8f8bcc15c6ae5ac050801cd6dcfd428fb5f9e65c4e16e7807340fa
`, version.ClientName, types.ModuleName,
			),
		),
